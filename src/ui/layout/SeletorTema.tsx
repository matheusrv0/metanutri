...
export function SeletorTema() {
  ...
  return (
    <div role="radiogroup" aria-label="Aparência" className="grid grid-cols-3 border border-border">
      {OPCOES.map((o, i) => {
        ...
        return (
          <button
            ...
            className={cn(
              ...
              marcado ? 'bg-card text-foreground' : 'text-muted-foreground hover:text-foreground',
            )}
          >
            {o.icone}
            {o.rotulo}
